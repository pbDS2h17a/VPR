...
public class GameButton extends Button {
	...
	private final String style_button_pressed = "-fx-background-color:transparent; -fx-background-image: url('resources/blue_button_pressed.png');";
	private final String style_button_released = "-fx-background-color:transparent; -fx-background-image: url('resources/blue_button_released.png');";
